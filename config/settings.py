...
CIAN_DETAIL_POLL_BATCH_SIZE = int(os.getenv("CIAN_DETAIL_POLL_BATCH_SIZE", "7"))
CIAN_DETAIL_POLL_DELAY_MIN_SECONDS = float(os.getenv("CIAN_DETAIL_POLL_DELAY_MIN_SECONDS", "90"))
CIAN_DETAIL_POLL_DELAY_MAX_SECONDS = float(os.getenv("CIAN_DETAIL_POLL_DELAY_MAX_SECONDS", "120"))

DOMCLICK_STATE_DIR = Path(os.getenv("DOMCLICK_STATE_DIR", str(BASE_DIR / ".domclick-state")))
DOMCLICK_PROXY_URL = os.getenv("DOMCLICK_PROXY_URL", "")
DOMCLICK_PERSISTENT_PROFILE = os.getenv("DOMCLICK_PERSISTENT_PROFILE", "true").lower() == "true"
...
PUBLIC_BASE_URL = os.getenv("PUBLIC_BASE_URL", "http://188.120.244.43").rstrip("/")
DOMCLICK_AGENT_TOKEN = os.getenv("DOMCLICK_AGENT_TOKEN", "")
DOMCLICK_AGENT_POLL_SECONDS = max(2, int(os.getenv("DOMCLICK_AGENT_POLL_SECONDS", "5")))
